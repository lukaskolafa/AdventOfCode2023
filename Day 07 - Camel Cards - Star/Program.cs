...
{
    static readonly char[] CardValues = {'A', 'K', 'Q', 'T', '9', '8', '7', '6', '5', '4', '3', '2', 'J' };
...
public class Hand : IComparable
{
    ...
    public Hand(string data, int bid)
    {
        ...
        int jCount = this.OriginalHand.Count(c => c == 'J');
        ...
        else if (this.Counts[0] == 4) // Four of a kind
        {
            if (jCount > 0)
            {
                this.Value = 7; // like Five of a kind
            }
            else
            {
                this.Value = 6;
        ...
        else if (this.Counts[0] == 3 && this.Counts[1] == 1) // Three of a kind
        {
            if (jCount > 0)
            {
                this.Value = 6; // like Four of a kind
            }
            else
            {
                this.Value = 4;
        ...
        else if (this.Counts[0] == 2) // One pair
        {
            if (jCount > 0)
            {
                this.Value = 4; // like Three of a kind
            }
            else
            {
                this.Value = 2;
